...
SOURCE_FILES = [
    ...
    'kin_cartesian.c', 'kin_6axis.c', 'kin_corexy.c', 'kin_corexz.c', 'kin_delta.c',
...
defs_kin_6axis = """
    struct stepper_kinematics *cartesian_6axis_stepper_alloc(char axis);
"""
...
defs_all = [
    ...
    defs_kin_cartesian, defs_kin_6axis, defs_kin_corexy, defs_kin_corexz, defs_kin_delta,
